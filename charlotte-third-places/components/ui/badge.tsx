  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "default-no-hover": "border-transparent bg-primary text-primary-foreground shadow-sm",
        "secondary-no-hover": "border-transparent bg-secondary text-secondary-foreground",
        "destructive-no-hover": "border-transparent bg-destructive text-destructive-foreground shadow-sm",
