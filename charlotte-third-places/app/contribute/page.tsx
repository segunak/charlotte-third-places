            ...
            <div className="space-y-6">
                <Card className="border border-gray-300 shadow-sm">
                    ...
                    <CardContent>
                        ...
                        <Button className="mt-4 text-base sm:text-lg font-bold">New Place Form</Button>
                    </CardContent>
                </Card>
                ...
                <Card className="border border-gray-300 shadow-sm">
                    ...
                    <CardContent>
                        ...
                        <Button className="mt-4 text-base sm:text-lg font-bold">Enhancements Form</Button>
                    </CardContent>
                </Card>
                ...
                <Card className="border border-gray-300 shadow-sm">
                    ...
                    <CardContent>
                        ...
                        <Button className="mt-4 text-base sm:text-lg font-bold">Contact Site Creator</Button>
                    </CardContent>
                </Card>
            </div>
        </div>
